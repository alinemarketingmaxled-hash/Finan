...
(function () {
  const NAV = [
    ...
    { group: "Planejamento", items: [
      { id: "visaoestrategica", label: "Visão Estratégica", icon: "flag" },
      { id: "metas", label: "Metas", icon: "target" },
      { id: "orcamento", label: "Orçamento", icon: "wallet" },
      { id: "pipeline", label: "Compromissos Futuros", icon: "users" },
      { id: "visaofutura", label: "Visão Futura", icon: "eye" },
  ...
  const TITLES = {
    ...
    pipeline: ["Compromissos Futuros", "Entradas e saídas futuras que você já sabe que vão acontecer, mesmo parceladas"],
    visaofutura: ["Visão Futura", "Confirmado + Estimado + Projetado, mês a mês, nos próximos 6 meses"],
    forecast: ["Forecast", "Projeção estatística pura por tendência dos últimos meses, 12 meses à frente"],
